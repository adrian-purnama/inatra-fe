...
const homeCards = [
  ...
  },
  {
    ...
    description: "Your pipeline, opportunities, and quotation metrics.",
    to: "/dashboard/presales",
    icon: "dashboard",
    when: "auth",
    requiredAny: ["get_dashboard_presales"],
    category: "normal",
  },
  {
    id: "overall-dashboard",
    title: "Overall dashboard",
    description: "Team-wide pipeline and quotation overview.",
